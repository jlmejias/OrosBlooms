...
async function main() {
  ...
  if (!row || row.categories !== 6 || row.products !== 6 || row.floral !== 4 || row.complements !== 1 || row.personalized !== 1 || row.variants !== 6 || row.product_images !== 4 || row.services !== 2 || row.gallery_items !== 1 || row.public_fake_testimonials !== 0 || row.missing_categories !== 0) {
